                ...
                <div class="form-box  ">
                  <div class="panel panel-danger">
                    <div class="panel-heading">
                      <h3 class="margin-bottom-10" align="center">يرجى ملء البيانات اللازمة</h3>
                    </div>
                    <div class="panel-body">

                      <div class="form-bottom" style="background-color:white" align="center">
                        <form role="form" action="addCustomer" method="post" class="registration-form">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                          <div class="form-group">
                            <label class="sr-only" for="customername">First name</label>
                            <input type="text" name="customername" placeholder="الاسم .." class="form-first-name form-control" id="form-first-name">
                          </div>
                          <div class="form-group">
                            <label class="sr-only" for="id">ID</label>
                            <input type="text" name="id" placeholder="الرقم الوطني" class="form-last-name form-control" id="form-last-name">
                          </div>

                          <div class="form-group">
                            <label class="sr-only" for="form-about-yourself">Address</label>
                            <textarea name="address" placeholder="العنوان .." class="form-about-yourself form-control" id="form-about-yourself"></textarea>
                          </div>
                          <div align="center">
                          ...
                          <button type="submit" class="btn" style="background-color: indianred">إضافة مشترك</button>
